...
def versao():
    ...
    v139: Dashboard — o Ranking de vendedoras agora mostra TODAS as vendedoras ativas (mesmo sem vendas), com todos os indicadores, incl. clientes cadastrados (antes ficava "Sem vendas" e escondia tudo). ✅<br>
