...
def versao():
    ...
    v139: Visão Geral — reorganizada em 14 quadrantes na ordem definida (faturamento bruto dinheiro+pix / cartão / total; líquido; % bruto×líquido; despesas fixas/avulsas; lucro líquido; total em caixa; crediário; condicional; valor/custo/potencial de estoque). Grid responsivo (menos colunas no tablet/celular) mantendo o padrão dos cards. ✅<br>
