...
def versao():
    ...
    v139: Estoque — filtro de PERÍODO por data de lançamento (De/Até + Hoje/7 dias/Mês/Todos, padrão das outras abas); quadrantes (custo/valor/potencial) e tabela passam a refletir o período escolhido (Todos = tudo, comportamento atual). Editar produto agora permite ADICIONAR/trocar/remover a FOTO (só grava a foto se foi alterada). ✅<br>
