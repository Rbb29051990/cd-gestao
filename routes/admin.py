...
def healthz():
    try:
        ...
        return jsonify({'status': 'ok', 'version': 'v129'})
...
def versao():
    ...
    <b>CD Gestão</b><br>
    Versão: <b style='color:green'>v129 — 2026-06-18</b><br>
    v129: Dashboard — gráficos voltam a refletir o PERÍODO selecionado (por dia/semana/mês), em vez de "12 meses fixos" que ficavam vazios numa empresa recém-implantada. Versões unificadas (healthz/README) ✅<br>
