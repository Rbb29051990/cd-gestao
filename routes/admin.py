...
def versao():
    ...
    v139: Nova venda — busca de produto por NOME/descrição/código (não só pelo código), com lista mostrando foto, estoque e preço (igual à aba Consulta). Clicar seleciona o produto; reduz erro de vender item errado quando a etiqueta sumiu. ✅<br>
