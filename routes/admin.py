...
def healthz():
    try:
        ...
        return jsonify({'status': 'ok', 'version': 'v125'})
...
def versao():
    ...
    <b>CD Gestão</b><br>
    Versão: <b style='color:green'>v125 — 2026-06-17</b><br>
    ...
    v125: Gráficos do dashboard passam a refletir o PERÍODO selecionado (por dia/semana/mês conforme a duração), funcionando mesmo numa empresa recém-implantada, sem histórico de meses anteriores ✅<br>
