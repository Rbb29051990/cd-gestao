...
def versao():
    ...
    v139: Estoque — filtro de PERÍODO por data de lançamento no formato padrão das outras abas (De/Até + Hoje/7 dias/Mês, começa no mês vigente); quadrantes (custo/valor/potencial) e tabela refletem o período escolhido. Editar produto agora permite ADICIONAR/trocar/remover a FOTO (só grava a foto se foi alterada). ✅<br>
